# Contributing to gsm.digitpref

This outlines how to propose a change to gsm.digitpref.
...
*   Fork the package and clone onto your computer. If you haven't done this before, we recommend using `usethis::create_from_github("OpenRBQM/gsm.digitpref")`.
...
Please note that the gsm.digitpref project is released with a
