...
#' @returns A [tibble::tibble()] with a column for the original vector (named
...
#'
#' @returns An integer vector of digits from the numbers, at the given place.
#' @keywords internal
...
#'
#' @returns A special numeric vector class from [tibble::num()] to display the
#'   number.
#' @keywords internal
...
#'
#' @returns A 2-column character matrix, where the first column contains
...
#'
#' @returns A named list of vectors of digits. Each element of the list contains
